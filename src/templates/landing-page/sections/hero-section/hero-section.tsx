  ...
  return (
    <section className="container relative flex items-center justify-center mt-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem] items-center">
        ...
        <div className="relative h-[20rem] hidden md:full order-first md:order-last items center justify-center md:flex lg:flex">
          <Image
            src='/hero-section.svg'
            alt='Illustração com ícones de loja, tag e sacola'
            width={200}
            height={400}
